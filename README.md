...
running command...
$ hereya (--version)
hereya-cli/0.11.0 darwin-arm64 node-v20.18.1
$ hereya --help [COMMAND]
USAGE
  $ hereya COMMAND
...
...
_See code: [src/commands/remote/exec/index.ts](https://github.com/hereya/hereya-cli/blob/v0.11.0/src/commands/remote/exec/index.ts)_
